...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .form-info .contact-details {
            display: flex;
            flex-direction: column;
            gap: 14px;
        }
        .form-info .contact-details .cd-item {
            display: flex;
            align-items: center;
            gap: 14px;
            color: var(--text-muted);
        }
        .form-info .contact-details .cd-item i {
            color: var(--primary);
            font-size: 1.3rem;
            width: 28px;
            text-align: center;
...
<body>
    ...
    <header id="header">
        <div class="container nav">
            <a href="#" class="logo">
                <i class="fas fa-sun"></i> Insta<span>Tan</span>
            </a>
    ...
    <section class="slider-section" id="slider">
        <div class="container">
            ...
            <div class="slider-controls">
                <button class="slider-btn" id="prevSlide" aria-label="Предыдущий слайд">
                    <i class="fas fa-chevron-left"></i>
                </button>
                <div class="slider-dots" id="sliderDots"></div>
                <button class="slider-btn" id="nextSlide" aria-label="Следующий слайд">
    ...
    <section class="products-section" id="products">
        <div class="container">
            <div class="section-title">
                ...
                <p>Всё для идеального загара и ухода за кожей</p>
            </div>
    ...
    <section class="testimonials-section" id="testimonials">
        <div class="container">
            <div class="section-title">
                <h2>Что говорят <span>атлеты</span></h2>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="author">
                        ...
                        <div>
                            ...
                            <div class="role">Триатлет, 3 года</div>
                        </div>
                    </div>
                </div>
                <div class="testimonial-card">
    ...
    <section class="form-section" id="order">
        <div class="container">
            <div class="form-grid">
                <div class="form-info">
                    <h2>Оставь <span>заявку</span></h2>
                    <p>
                        Мы свяжемся с тобой в течение 15 минут, поможем подобрать продукт и
                        оформим заказ с доставкой по всей России.
                    </p>
                ...
                <div class="form-card" id="formCard">
                    ...
                    <p class="form-sub">Заполни форму, и мы всё сделаем за тебя</p>
                    ...
                    <form id="orderForm" novalidate>
                        ...
                        <div class="form-group">
                            <label for="message">Комментарий / пожелания</label>
                            <textarea id="message" placeholder="Напишите, что вас интересует..."></textarea>
                        </div>
    ...
    <footer>
        <div class="container footer-grid">
            ...
            <div class="copy">
                &copy; 2026 InstaTan. Все права защищены.
            </div>
        </div>
    </footer>
